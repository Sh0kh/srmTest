...
`;
  ...
  const edtiContract = (e) => {
    ...
    formData.append("pasport", editItem.passport_series);
    formData.append("data", editItem.contract_date);
    formData.append("adrress",editItem.info_address);
    formData.append("Bank",editItem.info_bank);
    formData.append("telefon", editItem.phone_number);
    ...
    if (selectedFile) {
      ...
      formData.append( "img", editItem.image);
    }
